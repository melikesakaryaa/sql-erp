...
GO
-- --------------------------------------------------------------------------------------------
create procedure [dbo].[pdxAPVendor]  @AgingDate Datetime , @FK_dxVendor int, @Posted int = 1
as
...
and  (cr.posted = 1 or cr.posted = @Posted)  and cr.TransactionDate <= @AgingDate  ),2)) <> 0.0
